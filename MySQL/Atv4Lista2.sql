...
INSERT into tb_produto (nome, valor , vencimento , fk_cat)
	values ("Couve-flor", 15, "2022-03-22", 4),
	("Banana", 17, "2022-06-01", 1),
	("Alho-poro", 25, "2025-12-01", 4),
	("Maçã", 30, "2025-12-01", 1),
	("Abóbora", 55, "2022-01-09",2),
	("Cenoura", 5, "2023-01-01", 2),
	("Arroz ", 62, "2023-10-30", 3),
	("Alface", 2, "2023-05-01", 5);
...
FROM tb_categoria 
INNER JOIN tb_produto on tb_categoria.id_cat = tb_produto.fk_cat 
WHERE tb_categoria.categoria = 'Legumes' ;